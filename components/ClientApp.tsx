...
import { AuthState, Entity, Category, NavItem, Supplier, StockItem, MandatoryProtocol, DeptStockItem, DeptStockBatch, DeptStockTransaction, CookingRecordEntry, CoolingRecordEntry, ReheatingEntry } from '../types';
...
const ClientApp: React.FC = () => {
  ...
  // Next.js PWA Service Worker Registration
  useEffect(() => {
  ...
  const handleCookIssueToCooling = (cookEntry: CookingRecordEntry, quantity: number) => {
      ...
      const newCoolEntry: CoolingRecordEntry = {
          ...
          cookTemp: typeof cookEntry.finalTemp === 'number' ? cookEntry.finalTemp : 0,
          ...
          cookingTimeLapse: 'Automatic Handshake',
